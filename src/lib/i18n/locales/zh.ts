...
export const zhTranslations: Translations = {
  ...
  manifesto: {
    title: '我们的宣言',
    p1: '一群在代码与梦想交汇处相遇的人——这里有深夜调试的学生，有追求优雅的开发者，也有痴迷于「如何让世界更高效、更清洁」的可持续技术信徒。',
    p2DifferentLabel: '我们不同',
    p2Different: '专业、背景，甚至喜欢的编程语言，都可能不一样。',
    p2SameLabel: '我们相同',
    p2Same: '相信技术向善，相信年轻的力量，相信「可持续」不是选择，而是必须。',
    p3: '在这里，好奇心是通行证，实践是通用语。我们不只是构建产品，更是在构建心中那个更绿色、更公平、更智能的未来。',
    slogan: '我们，是一个行动动词。'
  },
  team: {
    title: '我们是谁？',
    shortDescription: '遇见社区的建设者们——维护者、开发者、设计师与贡献者。',
    ...
    maintainers: [
      ...
      },
      {
        ...
        image: 'https://cdn.newenergycoder.club/images/src/image/maintainer/张旺旺.jpg',
    ...
    developers: [
      ...
      },
      {
        ...
        image: 'https://cdn.newenergycoder.club/images/src/image/developer/单广志.png',
