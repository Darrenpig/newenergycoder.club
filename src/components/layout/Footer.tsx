    ...
    <footer className="bg-secondary mt-auto pt-10 pb-6">
      <div className="container grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="https://docs.newenergycoder.club/" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground">{t.footer.documentation || '文档中心'}</a></li>
